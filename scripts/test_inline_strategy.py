...
of TEST_OVERHEAD steps to calculate per-settlement efficiency.
...
class InlineStrategyTester:
        ...
        for current_test, value in enumerate(strategy_values, start=1):
            ...
            if value == AVOID_STRATEGY:
                ...
                if contract_size > 0 and l2_gas > 0:
                    ...
                    cairo_steps_per_settlement = (
                        total_cairo_steps - overhead_gas
                    ) / num_settlements
                    ...
                    print(
                        ...
                        f"Total L2 Gas={total_cairo_steps:,}, "
                        f"L2 Gas/Settlement={cairo_steps_per_settlement:,.0f}"
                    )
            ...
            if contract_size > 0 and l2_gas > 0:
                total_cairo_steps = l2_gas
                cairo_steps_per_settlement = (total_cairo_steps - overhead_gas) / num_settlements
    ...
    def plot_results(self, results: dict, output_file: str = "inline_strategy_results.png") -> None:
        ...
        if results.get("avoid_data"):
            ...
            ax1.text(
                0.50,
                0.94,
                f"Baseline L2 Gas/Settlement: " f'{avoid["cairo_steps_per_settlement"]:,.0f}',
                transform=ax1.transAxes,
                fontsize=12,
                verticalalignment="top",
                horizontalalignment="center",
    ...
    def print_summary(self, results: dict) -> None:
        ...
        for i, strategy in enumerate(results["strategies"]):
            ...
            print(
                f"{strategy:<12} {size:>15,} felts  {total_steps:>20,}     "
                f"{steps_per_settlement:>20,.0f}     {size_change:<20} "
                f"{steps_change:<20}"
            )

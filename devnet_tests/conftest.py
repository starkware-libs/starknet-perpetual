...
# When changing the forked number, need to update NOW and EXTENDED_SYNTHETIC_ASSET_IDS
FORK_BLOCK = 4415803
NOW = 1765971224
...
@pytest.fixture(scope="session")
def governance_admin_address() -> int:
    """
    Return the constant address of the 'governance admin' contract as an int.
    """
    return 0x522E5BA327BFBD85138B29BDE060A5340A460706B00AE2E10E6D2A16FBF8C57
...
async def contracts(
    ...
    """
    return await contracts_inner_fixture(contract_address, accounts)

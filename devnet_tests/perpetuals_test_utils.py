...
class PerpetualsTestUtils:
    ...
    async def upgrade_perpetuals_contract(
        ...
        """
        deployer_contract = self.known_contracts["deployer"]
        new_class_hash_result = await declare_contract("perpetuals_Core", deployer_contract)
        new_class_hash = new_class_hash_result.class_hash

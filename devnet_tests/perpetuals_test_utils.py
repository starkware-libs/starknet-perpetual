...
class PerpetualsTestUtils:
    ...
    async def fund_account_with_collateral(self, account: Account, amount: int):
    ...
    async def deposit(self, account: Account, amount: int):
        # First, fund the account with collateral tokens
        await self.fund_account_with_collateral(account, amount)

...
[get\_message\_hash](#get-message-hash) on [RedeemFromVaultUserArgs](#withdrawfromvaultuserargs) with `position_id` public_key.

[get\_message\_hash](#get-message-hash) on [RedeemFromVaultOwnerArgs](#withdrawfromvaultownerargs) with `vault_position_id` public_key.

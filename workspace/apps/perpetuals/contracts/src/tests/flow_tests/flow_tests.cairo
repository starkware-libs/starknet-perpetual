...
fn test_two_users_ten_synthetics_flow() {
    ...
    test.withdraw(test.withdraw_request(user_a, 1_000_000), interest_amount: 0);
    test.withdraw(test.withdraw_request(user_b, 1_000_000), interest_amount: 0);
...
fn test_multi_trade_with_price_and_funding_ticks() {
    ...
    test.withdraw(test.withdraw_request(user: user_a, amount: 1_000_000), interest_amount: 0);
    test.withdraw(test.withdraw_request(user: user_b, amount: 1_000_000), interest_amount: 0);

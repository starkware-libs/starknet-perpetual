...
fn SETTLEMENT_1() -> Settlement {
    Settlement {
        ...
        order_b: Order {
            ...
            base_asset_id: AssetIdTrait::new(0x47524153532d310000000000000000),
            base_amount: (-250340).try_into().unwrap(),
            quote_asset_id: AssetIdTrait::new(0x1),
        ...
        actual_amount_quote_a: (-442389000).try_into().unwrap(),
...
fn SETTLEMENT_2() -> Settlement {
    Settlement {
        ...
        order_a: Order {
            ...
            quote_asset_id: AssetIdTrait::new(0x1),
            quote_amount: (-150853900).try_into().unwrap(),
            fee_asset_id: AssetIdTrait::new(0x1),
        ...
        order_b: Order {
            ...
            base_asset_id: AssetIdTrait::new(0x5345492d3000000000000000000000),
            base_amount: (-330).try_into().unwrap(),
            quote_asset_id: AssetIdTrait::new(0x1),
        ...
        actual_amount_quote_a: (-93927900).try_into().unwrap(),
        actual_fee_a: 0,
...
fn SETTLEMENT_3() -> Settlement {
    Settlement {
        ...
        order_a: Order {
            ...
            quote_asset_id: AssetIdTrait::new(0x1),
            quote_amount: (-92795457700).try_into().unwrap(),
            fee_asset_id: AssetIdTrait::new(0x1),
        ...
        order_b: Order {
            position_id: POSITION_ID_0x1f9,
            base_asset_id: AssetIdTrait::new(0x4f4e444f2d31000000000000000000),
            base_amount: (-260).try_into().unwrap(),
            quote_asset_id: AssetIdTrait::new(0x1),
        ...
        actual_amount_quote_a: (-25082200).try_into().unwrap(),
        actual_fee_a: 0,

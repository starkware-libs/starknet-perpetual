...
fn test_performance() {
    let operator_address: ContractAddress =
    ...
    // Replace class hash:
    let replacer = IReplaceableDispatcher { contract_address };
    ...
    cheat_caller_address_once(:contract_address, caller_address: operator_address);

...
fn settlement_1() -> Settlement {
    Settlement {
        ...
        order_a: Order {
            ...
            quote_amount: (-1321410000).try_into().unwrap(),
        ...
        order_b: Order {
            ...
            base_asset_id: 0x485950452d33000000000000000000.into(),
            base_amount: (-6760).try_into().unwrap(),
            quote_asset_id: 0x1.into(),
        ...
        actual_amount_quote_a: (-11053750).try_into().unwrap(),
        actual_fee_a: 0xacb,
        actual_fee_b: 0x0,
    }
}
...
fn settlement_2() -> Settlement {
    Settlement {
        ...
        order_a: Order {
            ...
            quote_asset_id: 0x1.into(),
            quote_amount: (-17686368000).try_into().unwrap(),
            fee_asset_id: 0x1.into(),
        ...
        order_b: Order {
            position_id: PositionId { value: 0x30d7e.try_into().unwrap() },
            base_asset_id: 0x4554482d3400000000000000000000.into(),
            base_amount: (-4220).try_into().unwrap(),
            quote_asset_id: 0x1.into(),
        ...
        actual_amount_quote_a: (-147963000).try_into().unwrap(),
        actual_fee_a: 0x820b,
        actual_fee_b: 0x0,
    }
}
...
fn settlement_3() -> Settlement {
    Settlement {
        ...
        order_a: Order {
            ...
            quote_asset_id: 0x1.into(),
            quote_amount: (-301100880).try_into().unwrap(),
            fee_asset_id: 0x1.into(),
        ...
        order_b: Order {
            position_id: PositionId { value: 0x31303.try_into().unwrap() },
            base_asset_id: 0x4254432d3600000000000000000000.into(),
            base_amount: (-64970).try_into().unwrap(),
            quote_asset_id: 0x1.into(),
        ...
        actual_amount_quote_a: (-124117920).try_into().unwrap(),
        actual_fee_a: 0x0,
        actual_fee_b: 0x6d16,
    }
}
...
fn settlement_4() -> Settlement {
    Settlement {
        ...
        order_a: Order {
            ...
            quote_asset_id: 0x1.into(),
            quote_amount: (-17412000000).try_into().unwrap(),
            fee_asset_id: 0x1.into(),
        ...
        order_b: Order {
            ...
            base_asset_id: 0x5452554d502d310000000000000000.into(),
            base_amount: (-27810).try_into().unwrap(),
            quote_asset_id: 0x1.into(),
        ...
        actual_amount_base_a: 0xfa,
        actual_amount_quote_a: (-217850000).try_into().unwrap(),
        actual_fee_a: 0xbf78,
        actual_fee_b: 0x0,
    }
}
...
fn settlement_5() -> Settlement {
    Settlement {
        ...
        order_a: Order {
            ...
            base_amount: 0x2710.try_into().unwrap(),
            quote_asset_id: 0x1.into(),
            quote_amount: (-14219400000).try_into().unwrap(),
            fee_asset_id: 0x1.into(),
        ...
        order_b: Order {
            position_id: PositionId { value: 0x30d7e.try_into().unwrap() },
            base_asset_id: 0x454e412d3000000000000000000000.into(),
            base_amount: (-420).try_into().unwrap(),
            quote_asset_id: 0x1.into(),
        ...
        actual_amount_base_a: 0xfa,
        actual_amount_quote_a: (-177742500).try_into().unwrap(),
        actual_fee_a: 0x9c38,
        actual_fee_b: 0x0,
    }
}
...
fn settlement_6() -> Settlement {
    Settlement {
        ...
        order_a: Order {
            ...
            quote_asset_id: 0x1.into(),
            quote_amount: (-13084650).try_into().unwrap(),
            fee_asset_id: 0x1.into(),
        ...
        order_b: Order {
            position_id: PositionId { value: 0x19cb3.try_into().unwrap() },
            base_asset_id: 0x424e422d3400000000000000000000.into(),
            base_amount: (-140000).try_into().unwrap(),
            quote_asset_id: 0x1.into(),
        ...
        actual_amount_quote_a: (-13084650).try_into().unwrap(),
        actual_fee_a: 0x0,
        actual_fee_b: 0xb80,
    }
}
...
fn settlement_7() -> Settlement {
    Settlement {
        ...
        order_a: Order {
            ...
            quote_asset_id: 0x1.into(),
            quote_amount: (-12210520).try_into().unwrap(),
            fee_asset_id: 0x1.into(),
        ...
        actual_amount_quote_a: (-12210520).try_into().unwrap(),
        actual_fee_a: 0x0,
        actual_fee_b: 0xabb,
    }
}
...
fn settlement_8() -> Settlement {
    Settlement {
        ...
        order_a: Order {
            ...
            quote_asset_id: 0x1.into(),
            quote_amount: (-10464600).try_into().unwrap(),
            fee_asset_id: 0x1.into(),
        ...
        actual_amount_quote_a: (-10464600).try_into().unwrap(),
        actual_fee_a: 0x0,
        actual_fee_b: 0x932,
    }
}
...
fn settlement_9() -> Settlement {
    Settlement {
        ...
        order_a: Order {
            ...
            quote_asset_id: 0x1.into(),
            quote_amount: (-84584970).try_into().unwrap(),
            fee_asset_id: 0x1.into(),
        ...
        actual_amount_quote_a: (-84584970).try_into().unwrap(),
        actual_fee_a: 0x0,
        actual_fee_b: 0x4a57,
    }
}
...
fn settlement_10() -> Settlement {
    Settlement {
        ...
        order_a: Order {
            ...
            quote_asset_id: 0x1.into(),
            quote_amount: (-4008446090).try_into().unwrap(),
            fee_asset_id: 0x1.into(),
        ...
        actual_amount_quote_a: (-82837150).try_into().unwrap(),
        actual_fee_a: 0x0,
        actual_fee_b: 0x48ce,
    }
}
...
fn settlement_11() -> Settlement {
    Settlement {
        ...
        order_a: Order {
            ...
            quote_asset_id: 0x1.into(),
            quote_amount: (-24597000).try_into().unwrap(),
            fee_asset_id: 0x1.into(),
        ...
        order_b: Order {
            ...
            base_asset_id: 0x4144412d3100000000000000000000.into(),
            base_amount: (-1650).try_into().unwrap(),
            quote_asset_id: 0x1.into(),
        ...
        actual_amount_quote_a: (-24545700).try_into().unwrap(),
        actual_fee_a: 0x17f8,
        actual_fee_b: 0x0,
    }
}
...
fn settlement_12() -> Settlement {
    Settlement {
        ...
        order_a: Order {
            ...
            quote_asset_id: 0x1.into(),
            quote_amount: (-149666400).try_into().unwrap(),
            fee_asset_id: 0x1.into(),
            fee_amount: 0x0.try_into().unwrap(),
        ...
        order_b: Order {
            position_id: PositionId { value: 0x1f9.try_into().unwrap() },
            base_asset_id: 0x5749462d3100000000000000000000.into(),
            base_amount: (-360).try_into().unwrap(),
            quote_asset_id: 0x1.into(),
        ...
        actual_amount_quote_a: (-31881600).try_into().unwrap(),
        actual_fee_a: 0x0,
        actual_fee_b: 0x1f22,
    }
}

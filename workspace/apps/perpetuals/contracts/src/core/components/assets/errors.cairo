...
pub const CANNOT_REGISTER_THIS_ASSET_TYPE: felt252 = 'CANNOT_REGISTER_THIS_ASSET_TYPE';
...
pub const MISSING_ERC20_ADDRESS_FOR_VAULT: felt252 = 'MISSING_ERC20_ADDRESS_FOR_VAULT';

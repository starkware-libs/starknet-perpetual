...
pub mod AssetsComponent {
    ...
    use perpetuals::core::components::assets::errors::{
        ...
        NOT_SYNTHETIC, NO_TOKEN_CONTRACT, ORACLE_ALREADY_EXISTS, ORACLE_NAME_TOO_LONG,
    ...
    > of InternalTrait<TContractState> {
        ...
        fn get_asset_type(self: @ComponentState<TContractState>, asset_id: AssetId) -> AssetType {
            ...
            match SyntheticTrait::get_asset_type(entry) {
                Option::None => panic_with_felt252(ASSET_NOT_EXISTS),
        ...
        fn get_token_contract_and_quantum(
            ...
            if (self.get_collateral_id() == asset_id) {
                ...
                let token_contract_address = asset_config.token_contract.expect(NO_TOKEN_CONTRACT);
    ...
    > of PrivateTrait<TContractState> {
        ...
        fn _add_asset(
            ...
            let (asset_config, asset_added_event): (AssetConfig, Event) = match asset_type {
                AssetType::SYNTHETIC => {
                    (
                        SyntheticTrait::synthetic_config(
                            AssetStatus::PENDING,
                            risk_factor_first_tier_boundary,
                            risk_factor_tier_size,
                            quorum,
                ...
                AssetType::VAULT_SHARE_COLLATERAL => {
                    ...
                    (
                        SyntheticTrait::vault_share_config(
                            AssetStatus::PENDING,
                            risk_factor_first_tier_boundary,
                            risk_factor_tier_size,
                            quorum,

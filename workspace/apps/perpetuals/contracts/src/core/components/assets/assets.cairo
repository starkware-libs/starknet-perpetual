...
pub mod AssetsComponent {
    ...
    use perpetuals::core::components::assets::errors::Error::{
        ...
        INVALID_SAME_QUORUM, INVALID_SHARE_QUANTUM, INVALID_TIMESTAMP, INVALID_VAULT_RF_TIERS,
    ...
    > of InternalTrait<TContractState> {
        ...
        fn get_asset_price(self: @ComponentState<TContractState>, asset_id: AssetId) -> Price {
            ...
            match SyntheticTrait::get_price(entry) {
                Option::None => panic_with_byte_array(@NOT_SYNTHETIC.describe()),
        ...
        fn get_funding_index(
            ...
            match SyntheticTrait::get_funding_index(entry) {
                Option::None => panic_with_byte_array(@ASSET_NOT_EXISTS.describe()),

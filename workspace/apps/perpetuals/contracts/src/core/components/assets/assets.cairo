...
pub mod AssetsComponent {
    ...
    use perpetuals::core::components::assets::errors::{
        ...
        ASSET_REGISTERED_AS_COLLATERAL, CANNOT_REGISTER_THIS_ASSET_TYPE, COLLATERAL_NOT_REGISTERED,
        FUNDING_EXPIRED, FUNDING_TICKS_NOT_SORTED, INACTIVE_ASSET, INVALID_FUNDING_TICK_LEN,
        ...
        INVALID_ZERO_TOKEN_ADDRESS, MISMATCHED_RESOLUTION, NOT_SYNTHETIC, ORACLE_ALREADY_EXISTS,

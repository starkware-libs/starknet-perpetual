...
pub(crate) mod VaultsManager {
    ...
    use perpetuals::core::components::vaults::events;
    use perpetuals::core::components::vaults::vaults::Vaults::InternalTrait as VaultsInternal;
    use perpetuals::core::components::vaults::vaults::{IVaults, Vaults as VaultsComponent};
    use perpetuals::core::errors::order_expired_err;
    use perpetuals::core::types::asset::AssetId;
    ...
    use super::{
        ConvertPositionToVault, IVaultExternal, LimitOrder, Signature, panic_with_byte_array,
    };
    ...
    impl VaultsImpl of IVaultExternal<ContractState> {
        ...
        fn invest_in_vault(
            ...
            if now > order.expiration {
                panic_with_byte_array(@order_expired_err(from_position_id));
            }

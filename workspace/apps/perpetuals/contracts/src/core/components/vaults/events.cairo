...
pub struct ForcedRedeemFromVaultRequest {
    ...
    pub order_expiration: starkware_utils::time::time::Timestamp,
    ...
    pub vault_approval_expiration: starkware_utils::time::time::Timestamp,
    pub vault_approval_salt: felt252,
    #[key]
    pub order_hash: felt252,
    #[key]
    pub vault_approval_hash: felt252,
}
...
pub struct ForcedRedeemFromVault {
    ...
    pub vault_approval_expiration: starkware_utils::time::time::Timestamp,
    pub vault_approval_salt: felt252,
    pub actual_shares_user: i64,
    pub actual_collateral_user: i64,
    #[key]
    pub order_hash: felt252,
    #[key]
    pub vault_approval_hash: felt252,

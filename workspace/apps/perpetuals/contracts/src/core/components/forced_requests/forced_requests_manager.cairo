...
pub(crate) mod ForcedRequestsManager {
    ...
    impl ForcedRequestsManagerImpl of IForcedRequestsManager<ContractState> {
        ...
        fn forced_withdraw_request(
            ...
            self._collect_forced_action_premium(:caller);
    ...
    pub impl InternalImpl of InternalTrait {
        ...
        fn _collect_forced_action_premium(ref self: ContractState, caller: ContractAddress) {
            ...
            let outstanding_allowance = token_contract
                .allowance(owner: caller, spender: starknet::get_contract_address());
            ...
            assert(
                token_contract
                    .transfer_from(
                        sender: caller,
                        recipient: starknet::get_block_info().sequencer_address,
                        :amount,
                    ),
                TRANSFER_FAILED,
            );

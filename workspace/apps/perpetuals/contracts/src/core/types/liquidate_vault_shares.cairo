...
mod tests {
    ...
    fn test_liquidate_vault_shares_args_type_hash() {
        let expected = selector!(
            "\"LiquidateVaultSharesArgs\"(\"position_id\":\"PositionId\",\"vault_position_id\":\"PositionId\",\"collateral_id\":\"AssetId\",\"number_of_shares\":\"u64\",\"vault_share_execution_price\":\"Price\",\"expiration\":\"Timestamp\",\"salt\":\"felt\")\"PositionId\"(\"value\":\"u32\")\"AssetId\"(\"value\":\"felt\")\"Price\"(\"value\":\"u64\")\"Timestamp\"(\"seconds\":\"u64\")",
        );
        assert_eq!(

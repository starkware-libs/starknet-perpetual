...
/// An order to move collateral from a user position to a vault (invest).
...
mod tests {
    ...
    use super::{INVEST_IN_VAULT_TYPE_HASH, REDEEM_FROM_VAULT_TYPE_HASH};
    ...
    fn test_invest_in_vault_type_hash() {
        ...
        println!("Expected: {}", expected.into_base_16_string());

        assert!(INVEST_IN_VAULT_TYPE_HASH.into_base_16_string() == expected.into_base_16_string());
    }

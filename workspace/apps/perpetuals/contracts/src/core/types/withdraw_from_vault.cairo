...
const VAULT_WITHDRAW_OWNER_ARGS_TYPE_HASH: HashType =
    0x030a75fd628e0c62a6cf8a727b22681a47e278f104679fc3dd7a3cbeccc53e9d;
...
mod tests {
    ...
    fn test_vault_withdraw_owner_args_type_hash() {
        let expected = selector!(
            "\"VaultDepositArgs\"(\"vault_withdraw_user_hash\":\"TypeHash\",\"vault_share_execution_price\":\"Price\")\"Price\"(\"value\":\"u64\")",
        );
        assert_eq!(

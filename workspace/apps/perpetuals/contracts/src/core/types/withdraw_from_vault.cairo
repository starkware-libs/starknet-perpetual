...
pub struct VaultWithdrawUserArgs {
    ...
    pub minimum_received_total_amount: u128,
...
const VAULT_WITHDRAW_USER_ARGS_TYPE_HASH: HashType =
    0x003ce4ba8ee1b11157de6cbd9d77395e3dfb591ec22a07e724f3f118f439540f;
...
mod tests {
    ...
    fn test_vault_withdraw_user_args_type_hash() {
        let expected = selector!(
            "\"VaultWithdrawUserArgs\"(\"position_id\":\"PositionId\",\"vault_position_id\":\"PositionId\",\"number_of_shares\":\"u64\",\"minimum_received_total_amount\":\"u128\",\"expiration\":\"Timestamp\",\"salt\":\"felt\")\"PositionId\"(\"value\":\"u32\")\"Timestamp\"(\"seconds\":\"u64\")",
        );
        assert_eq!(

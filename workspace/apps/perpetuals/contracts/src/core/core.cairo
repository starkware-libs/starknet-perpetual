...
pub mod Core {
    ...
    use perpetuals::core::errors::{
        ...
        SIGNED_TX_EXPIRED, SYNTHETIC_IS_ACTIVE, TRANSFER_FAILED, fulfillment_exceeded_err,
        order_expired_err,
    };
    ...
    pub impl CoreImpl of ICore<ContractState> {
        ...
        fn withdraw_from_vault(
            ...
            minimum_received_total_amount: u128,
    ...
    pub impl InternalCoreFunctions of InternalCoreFunctionsTrait {
        ...
        fn _validate_withdraw_from_vault(
            ...
            assert(
                minimum_received_total_amount.into() <= quantized_shares_amount,

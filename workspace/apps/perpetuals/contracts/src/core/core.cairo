...
pub mod Core {
    ...
    pub impl InternalCoreFunctions of InternalCoreFunctionsTrait {
        ...
        fn _apply_interest_to_position(
            ...
            if old_balance_value.is_non_zero() && previous_timestamp.is_non_zero() {
                // Calculate time difference
                let time_diff: u64 = if current_time.seconds >= previous_timestamp.seconds {
                    current_time.seconds - previous_timestamp.seconds
                } else {

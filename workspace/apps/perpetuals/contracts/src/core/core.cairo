...
pub mod Core {
            ...
            for position_id in position_ids {
                ...
                self
                    ._apply_interest_to_position(
                        ...
                        interest_rate_scale: interest_rate_scale,
                    );
                i += 1;
            }
        }
    ...
    pub impl InternalCoreFunctions of InternalCoreFunctionsTrait {
        ...
        fn _apply_interest_to_position(
            ...
            let mut position = self.positions.get_position_mut(position_id: position_id);
            ...
            if old_balance_value != 0 {
                ...
                // First calculate: (|old_balance| * max_interest_rate_per_sec) / 2^32
                let rate_per_second = mul_wide_and_floor_div(
                    old_balance_abs, max_rate, interest_rate_scale.into(),
                )
                    .expect(AMOUNT_OVERFLOW);
                // Then multiply by time_diff
                let max_allowed_change: u128 = rate_per_second * time_diff.into();
                ...
                assert(interest_amount == 0, INVALID_INTEREST_RATE);
            }

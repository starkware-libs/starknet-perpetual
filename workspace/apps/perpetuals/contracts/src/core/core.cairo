    ...
    pub impl InternalCoreFunctions of InternalCoreFunctionsTrait {
        ...
        fn _deposit_to_vault_contract(
            ...
            let shares_amount = IERC4626Dispatcher { contract_address: vault_address }
                .deposit(assets: unquantized_amount.into(), receiver: contract_address);
            ...
            assert_eq!(after_deposit_balance, before_deposit_balance);
            assert_eq!(after_deposit_shares_balance, before_deposit_shares_balance + shares_amount);

...
pub mod Core {
    ...
    use perpetuals::core::errors::{
        ...
        POSITION_IS_VAULT_POSITION, REGISTER_VAULT_EXPIRED, SYNTHETIC_IS_ACTIVE, TRANSFER_EXPIRED,
    ...
    struct Storage {
        ...
        addresses_to_vault_positions: Map<ContractAddress, PositionId>,
        // --- Components ---
        #[substorage(v0)]
    ...
    pub impl CoreImpl of ICore<ContractState> {
        ...
        fn register_vault(
            ...
            // TODO(Omri): Add check for share assets. Need to modify the position data to include
            // share assets.

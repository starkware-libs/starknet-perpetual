...
pub mod Core {
    ...
    use perpetuals::core::errors::{
        ...
        TOTAL_AMOUNT_TOO_SMALL, TRANSFER_FAILED, VAULT_CONTRACT_ALREADY_EXISTS,
    ...
    pub impl CoreImpl of ICore<ContractState> {
        ...
        fn withdraw_from_vault(
            ...
            let actual_received_total_amount: u128 = vault_share_execution_price
    ...
    pub impl InternalCoreFunctions of InternalCoreFunctionsTrait {
        ...
        fn _validate_withdraw_from_vault(
            ...
            vault_owner_signature: Signature,
            share_id: AssetId,
            actual_received_total_amount: u128,
            ...
            assert(
                minimum_received_total_amount <= actual_received_total_amount,
                TOTAL_AMOUNT_TOO_SMALL,
            );

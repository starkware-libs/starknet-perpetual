...
pub mod Core {
    ...
    pub impl CoreImpl of ICore<ContractState> {
        ...
        fn forced_redeem_from_vault_request(
            ...
            self
                ...
                .register_forced_approval(
                    ...
                    signature: signature,
                    args: ForcedRedeemFromVault { order, vault_approval },
                );

            validate_signature(
                public_key: vault_public_key,
                message: ForcedRedeemFromVault { order, vault_approval },
            ...
            self
                .emit(
                    vault_events::ForcedRedeemFromVaultRequest {
                        ...
                        order_hash: order.get_message_hash(public_key: public_key),
                        vault_approval_hash: vault_approval
                            .get_message_hash(public_key: vault_public_key),
                    },
                );
        }
        ...
        /// - Validates the request is not already completed.
        /// - Validates the forced request timeout has passed (unless operator).
            ...
            self
                .emit(
                    vault_events::ForcedRedeemFromVault {
                        ...
                        vault_approval_expiration: vault_approval.expiration,
                        vault_approval_salt: vault_approval.salt,
                        actual_shares_user: actual_shares_user,
                        actual_collateral_user: actual_collateral_user,
                        order_hash: order.get_message_hash(public_key: public_key),
                        vault_approval_hash: vault_approval
                            .get_message_hash(public_key: vault_public_key),
                    },

...
mod tests {
    ...
    fn test_basic_calculate_position_tvtr_before() {
        ...
        //tvtr_before.total_value = balance * PRICE_1() * PRICE_SCALE.into()
        //tvtr_before.total_risk = balance * PRICE_1() * RISK_FACTOR_1() * PRICE_SCALE.into()
    ...
    fn test_calculate_position_tvtr_before_with_multiple_assets() {
        ...
        //tvtr_before.total_value = balance_1 * PRICE_1() * PRICE_SCALE.into() + balance_2 *
        //PRICE_2() * PRICE_SCALE.into() + balance_3 * PRICE_3() * PRICE_SCALE.into() +
        //collateral_balance_before * PRICE_SCALE.into()
        //tvtr_before.total_risk = abs(balance_1) * PRICE_1() * RISK_FACTOR_1() * PRICE_SCALE.into()
        //+
        //abs(balance_2) * PRICE_2() * RISK_FACTOR_2() * PRICE_SCALE.into() + abs(balance_3) *
        //PRICE_3() *
        //RISK_FACTOR_3() * PRICE_SCALE.into()
    ...
    fn test_calculate_position_tvtr_before_no_unchanged_synthetics() {
        ...
        //tvtr_before.total_value = asset.balance * asset.price * PRICE_SCALE.into() +
        //collateral_balance_before * PRICE_SCALE.into()
